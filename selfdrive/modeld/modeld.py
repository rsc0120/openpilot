...
DISABLE_NAV = True if MODEL_NAME in ['north-dakota-v2', 'notre-dame', 'secret-good-openpilot'] else False
SECRET_GOOD_OPENPILOT = True if MODEL_NAME == 'secret-good-openpilot' else False
...
def main(demo=False):
  ...
  while True:
    ...
    nav_enabled = nav_valid and (params.get_bool("ExperimentalMode") or params.get_bool("NavChill")) and not DISABLE_NAV
